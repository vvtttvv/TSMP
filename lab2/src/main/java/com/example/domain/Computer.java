package src.main.java.com.example.domain;
...
public class Computer implements ComputerPrototype {
    private String name;
    ...
    protected Computer(Computer prototype) {
        if (prototype != null) {
            this.name = prototype.name;
            this.coolingSystem = prototype.coolingSystem;
            this.caseType = prototype.caseType;
            this.hasRGBLighting = prototype.hasRGBLighting;
            this.processor = prototype.processor;
            this.gpu = prototype.gpu;
            this.ram = prototype.ram;
            this.storage = prototype.storage;
        }
    }
